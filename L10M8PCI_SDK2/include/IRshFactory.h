 ...
 * \~english
 * \brief
 * IRshFactory interface.
 * 
 * RSH SDK v2.00 
 * 
 * \~russian
 * \brief
 * Интерфейс IRshFactory.
 * 
 * RSH SDK v2.00 
 * 
 */

#ifndef __IRSHFACTORY_H__
#define __IRSHFACTORY_H__
...
struct  IRshFactory 
{
	 ...
	 *
	 * \todo Убрать дефолтное значение для objectAddress? Все равно внутри проверка.
	 * 
	 * \see
	 * Free()
	 * 
	 */
	virtual U32   __RSHCALLCONV Release(IN OUT void** objectAddress = NULL) = 0; 
