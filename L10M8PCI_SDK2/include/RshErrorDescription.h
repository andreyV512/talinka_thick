...
#ifndef __RSH_ERROR_DESCRIPTION_H__
#define __RSH_ERROR_DESCRIPTION_H__
...
static  RshErrorDescription RshErrorList[] = {
  ...
  rshUTF16("На шине USB не обнаружено ни одной поддерживаемой платы."),
  ...
  rshUTF16("Функция не поддерживается платой."),
  rshUTF16("Function is not supported by this board.")},
  ...
  rshUTF16("Get-код не определен внутри функции ::Get."),
  rshUTF16("Get-code is not defined inside ::Get function.")},
  ...
  rshUTF16("There was an attempt to allocate a buffer of a zero size.")},
  ...
  rshUTF16("RSH_API_SCRIPT_CANTEVALUATE"),
  rshUTF16("RSH_API_SCRIPT_CANTEVALUATE")},

  {RSH_API_SCRIPT_STARTFUNCTIONDOESNOTEXIST,
  rshUTF16("RSH_API_SCRIPT_STARTFUNCTIONDOESNOTEXIST"),
  rshUTF16("RSH_API_SCRIPT_STARTFUNCTIONDOESNOTEXIST")},
...
#endif //__RSH_ERROR_DESCRIPTION_H__
