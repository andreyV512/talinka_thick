...
#ifndef __RSH_ERROR_H__
#define __RSH_ERROR_H__
...
public:
	 ...
	 * 
	 */
    static U32 GetSystemErrorDescriptionUTF16(U32 error, wchar_t* str, U32 maxLength);
	 ...
	 * 
	 */
    static U32 GetErrorDescriptionUTF16(U32 error, wchar_t* str, U32 maxLength, RSH_LANGUAGE language = RSH_LANGUAGE_ENGLISH);
	 ...
	 * 
	 */
    static void PrintErrorDebug(U32 error, wchar_t* message, bool includeSystemErrorInfo = false);
