...
#ifndef __RSH_STATUS_CODES_H__
#define __RSH_STATUS_CODES_H__

/*******************************************\
*         RSH API Return Code Values        *
\*******************************************/
		...
		enum _RSH_STATUS
{
  ...
  //! \ru: На шине USB не обнаружено ни одной поддерживаемой платы.
  ...
  //! \ru: Функция не поддерживается платой.
  //! \en: Function is not supported by this board.
  ...
  //! \ru: Get-код не определен внутри функции ::Get.
  //! \en: Get-code is not defined inside ::Get function.
  ...
  //! \en: There was an attempt to allocate a buffer of a zero size.
  ...
  //! \ru: PLX API - неправильная информация об устройстве
  ...
  //! \ru: PLX API - Неверная команда DMA.
